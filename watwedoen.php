...
<body>
    ...
    <br>
    <div class="ab">
    <img class="map" src="maps2.png" width="550" height="500">
    <h2 class="ab" >
  Marketing 
    </h2>
    <h3 class="c">
...
<li>Marketing uitvoering: we ontwikkelen het benodigde materiaal in onze studio.</li>
    </ul>
    </h3>
    <h2 class="ab">
        Webdevelopment
...
<li>Responsive websites, goed te bekijken op de pc, labtop, tablet en mobiel</li>
<li>Mobiele app’s</li>
...
<li><a href="app.php" style="color: #008cd4;">Applicatie en App ontwikkeling</a></li>
    ...
    <div class="b">
        ...
        Concept
        Identiteit, logo en huisstijl
        Communicatiemiddelen
        POS materiaal (Point-of-Sale)
        Brochures, folders en kranten
        Boeken en magazines
        </textarea>
        <textarea class="doen" rows="20" cols="62.5" disabled>
